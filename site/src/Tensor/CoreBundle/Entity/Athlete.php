...
class Athlete
{
    ...
    public function serializeArray()
    {
        return array(
            ...
            'cover' => $this->cover,
            'link' => $this->link,
            'country' => ($this->country) ? $this->country->serializeArray() : null,
             'medals' => $this->getSerializedMedals(),
        );
    }

    public function getSerializedMedals()
    {
        $medals = array();
        foreach($this->medals as $medal){ $medals[] = $medal->serializeArray(); }
    return $medals;
    }
